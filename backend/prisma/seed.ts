...
const providers = [
  {
    ...
    about:
      'Wise is an international money transfer and multi-currency services provider. Users can send money internationally and access supported currency services through Wise.',
    tagline: 'The smart way to send money abroad.',
    websiteUrl: 'https://wise.com',
    affiliateUrl: '', // Set when affiliate access is confirmed (OQ-3)
    trustpilotRating: 4.3,
    trustpilotCount: 230000,
    regulatoryInfo:
      'Wise Payments Limited is authorised as an Electronic Money Institution (EMI) by the Financial Conduct Authority (FCA) in the UK.',
  ...
  },
  {
    ...
    about:
      'LemFi (formerly Lemonade Finance) offers zero-fee international money transfers specialising in routes to Africa and Asia.',
  ...
  },
  {
    ...
    about:
      'Remitly is a reliable global money transfers service with promotional rates for first-time users.',
  ...
  },
  {
    ...
    about:
      'WorldRemit is a global money transfer service offering bank transfers, mobile money, cash pickup and airtime top-up.',
