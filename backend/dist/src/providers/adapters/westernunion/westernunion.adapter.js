...
var WesternUnionAdapter_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.WesternUnionAdapter = void 0;
const common_1 = require("@nestjs/common");
let WesternUnionAdapter = WesternUnionAdapter_1 = class WesternUnionAdapter {
    name = 'Western Union';
    logger = new common_1.Logger(WesternUnionAdapter_1.name);
    async getQuote(request) {
        this.logger.debug(`[MOCK] Fetching Western Union quote for ${request.sendAmount} ${request.sourceCurrency} → ${request.targetCurrency}`);
...
exports.WesternUnionAdapter = WesternUnionAdapter;
exports.WesternUnionAdapter = WesternUnionAdapter = WesternUnionAdapter_1 = __decorate([
    (0, common_1.Injectable)()
], WesternUnionAdapter);
//# sourceMappingURL=westernunion.adapter.js.map